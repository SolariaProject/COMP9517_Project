...
Image segmentation is the process of partitioning a digital image into multiple segments (sets of pixels, also known as image objects). \cite{haralick1985image} The goal of segmentation is to simplify and/or change the representation of an image into something that is more meaningful and easier to analyze. Image segmentation is typically used to locate objects and boundaries (lines, curves, etc.) in images. More precisely, image segmentation is the process of assigning a label to every pixel in an image such that pixels with the same label share certain characteristics.

\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{img/segmentation.png}
\caption{Object Detection and Segmentation}
\label{fig_sim}
\end{figure}

Instance segmentation is an approach that identifies, for every pixel, a belonging instance of the object. It detects each distinct object of interest in the image. For example, in this project, each leaf in the picture is segmented as an individual object. \cite{Hafiz_2020}
...
We use TensorBoard to visualize our training process data. 
...
\begin{subfigure}[h!]{0.24\textwidth}
    ...
    \caption{loss RPN classification}
...
This result of this model shows quite good.
