...
Instance segmentation \cite{Hafiz_2020} is an approach that identifies, for every pixel, a belonging instance of the object.
There are many ways to approach instance segmentation, for example, clustering KMeans algorithm, histogram-based methods, edge detection, and also deep learning methods.
